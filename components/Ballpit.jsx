...
const Ballpit = ({ className = '', followCursor = true, count, ...props }) => {
  ...
  useEffect(() => {
    ...
    spheresInstanceRef.current = createBallpit(canvas, { followCursor, count, ...props });
  ...
  useEffect(() => {
    if (spheresInstanceRef.current && typeof count === 'number') {
